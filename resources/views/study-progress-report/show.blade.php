...
<div class="container py-5" style="margin-top: 80px;">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <h1 class="page-title">View Study Progress Report</h1>
            ...
            <h4 class="form-title mb-4">Detail Study Progress Report</h4>
                ...
                <div class="card-body-modern">
                    ...
                    <div class="info-grid mb-4">
                        ...
                        <div class="info-item bg-white border-primary shadow-sm" style="border-color: rgba(37,99,235,0.2) !important;">
                            ...
                            <input type="text" name="nik" class="form-control form-control-sm border-0 p-0 fw-bold" value="{{ old('nik', $user- disabled readonly>nik) }}" placeholder="Enter NIK (Editable)">
                        </div>
                        <div class="info-item bg-white border-primary shadow-sm" style="border-color: rgba(37,99,235,0.2) !important;">
                            <div class="info-label text-primary">Company</div>
                            <input type="text" name="company" class="form-control form-control-sm border-0 p-0 fw-bold" value="{{ old('company', $user- disabled readonly>company) }}" placeholder="Enter Company (Editable)">
                        </div>
                        <div class="info-item bg-white border-primary shadow-sm" style="border-color: rgba(37,99,235,0.2) !important;">
                            <div class="info-label text-primary">Position</div>
                            <input type="text" name="position" class="form-control form-control-sm border-0 p-0 fw-bold" value="{{ old('position', $user- disabled readonly>position) }}" placeholder="Enter Position (Editable)">
                        </div>
                        <div class="info-item bg-white border-primary shadow-sm" style="border-color: rgba(37,99,235,0.2) !important;">
                            <div class="info-label text-primary">Department</div>
                            <select name="department_id" class="form-select form-select-sm border-0 p-0 fw-bold shadow-none select2" disabled>
                        ...
                        <div class="info-item bg-white border-primary shadow-sm" style="border-color: rgba(37,99,235,0.2) !important;">
                            ...
                            <select name="group_id" class="form-select form-select-sm border-0 p-0 fw-bold shadow-none select2" disabled>
                        ...
                        <div class="info-item bg-white border-primary shadow-sm" style="border-color: rgba(37,99,235,0.2) !important;">
                            ...
                            <select name="direktorat_id" class="form-select form-select-sm border-0 p-0 fw-bold shadow-none select2" disabled>
            ...
            <!-- 2. BASIC INFORMATION -->
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="semester" id="semester" class="form-control border-start-0 ps-0" required min="1" value="{{ old('semester', $latestReport- disabled readonly>semester) }}" placeholder="e.g. 3">
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">IPK (Semester Ini)</label>
                                <input type="number" name="gpa" class="form-control" step="0.01" min="0" max="4" value="{{ old('gpa', $latestReport- disabled readonly>gpa) }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Max IPK / GPA Scale</label>
                                <input type="number" name="max_gpa" class="form-control" step="0.01" min="0" max="4" value="{{ old('max_gpa', 4.00) }}" disabled readonly>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-card">
                    ...
                    <div class="card-body-modern">
                        ...
                        <table class="modern-table" id="completedCoursesTable">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" name="completed_courses_name[]" class="form-control" placeholder="e.g. Data Structure" disabled readonly></td>
                                    <td><input type="number" name="completed_courses_credits[]" class="form-control" min="1" placeholder="3" disabled readonly></td>
                                    <td><input type="text" name="completed_courses_grade[]" class="form-control" placeholder="A" disabled readonly></td>
                        ...
                        <table class="modern-table" id="ongoingCoursesTable">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" name="ongoing_courses_name[]" class="form-control" placeholder="e.g. Artificial Intelligence" disabled readonly></td>
                                    <td><input type="number" name="ongoing_courses_credits[]" class="form-control" min="1" placeholder="3" disabled readonly></td>
                        ...
                        <table class="modern-table" id="upcomingCoursesTable">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" name="upcoming_courses_name[]" class="form-control" placeholder="e.g. Machine Learning" disabled readonly></td>
                                    <td><input type="number" name="upcoming_courses_credits[]" class="form-control" min="1" placeholder="3" disabled readonly></td>
                    ...
                    <div class="card-body-modern">
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" name="thesis_title" class="form-control" value="{{ old('thesis_title', $latestReport- disabled readonly>thesis_title) }}" placeholder="Enter your thesis title">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Title Status</label>
                                <select name="thesis_title_status" class="form-select" disabled>
                            ...
                            <div class="col-md-8 mb-4">
                                ...
                                <input type="text" name="thesis_proposal" class="form-control" value="{{ old('thesis_proposal', $latestReport- disabled readonly>thesis_proposal) }}" placeholder="Enter your thesis proposal details">
                            </div>
                            <div class="col-md-4 mb-4">
                                <label class="form-label">Proposal Status</label>
                                <select name="thesis_proposal_status" class="form-select" disabled>
                                    <option value="">-- Select Status --</option>
                        ...
                        <div class="row bg-light p-3 rounded-3 mx-0 mb-4 border" style="border-color: #f1f5f9 !important;">
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="proposal_exam_status" class="form-select" disabled>
                                    <option value="">-- Select Status --</option>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="proposal_exam_date" class="form-control" value="{{ old('proposal_exam_date', $latestReport- disabled readonly>proposal_exam_date) }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Proposal Exam Score</label>
                                <input type="text" name="proposal_exam_score" class="form-control" value="{{ old('proposal_exam_score', $latestReport- disabled readonly>proposal_exam_score) }}" placeholder="e.g. 85 or A">
                            </div>

                            <div class="col-md-3 mb-3">
                                <label class="form-label">Proposal Revision</label>
                                <select name="proposal_revision_status" class="form-select" disabled>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="research_implementation_status" class="form-select" disabled>
                                    <option value="">-- Status --</option>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="data_collection_status" class="form-select" disabled>
                                    <option value="">-- Status --</option>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="data_analysis_status" class="form-select" disabled>
                                    <option value="">-- Status --</option>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="thesis_writing_status" class="form-select" disabled>
                                    <option value="">-- Status --</option>
                        ...
                        <div class="row bg-light p-3 rounded-3 mx-0 border mb-4" style="border-color: #f1f5f9 !important;">
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="thesis_exam_status" class="form-select" disabled>
                                    <option value="">-- Select Status --</option>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="thesis_exam_date" class="form-control" value="{{ old('thesis_exam_date', $latestReport- disabled readonly>thesis_exam_date) }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Thesis Exam Score</label>
                                <input type="text" name="thesis_exam_score" class="form-control" value="{{ old('thesis_exam_score', $latestReport- disabled readonly>thesis_exam_score) }}" placeholder="e.g. 90 or A">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Thesis Revision Status</label>
                                <select name="thesis_revision_status" class="form-select" disabled>
                                    <option value="">-- Select Status --</option>
                        ...
                        <div class="row bg-light p-3 rounded-3 mx-0 border" style="border-color: #f1f5f9 !important;">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="journal_article_status" class="form-select" disabled>
                                    <option value="">-- Select Status --</option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="journal_publication_status" class="form-select" disabled>
                                    <option value="">-- Select Status --</option>
                ...
                <div class="glass-card">
                    ...
                    <div class="card-body-modern">
                        <table class="modern-table" id="activitiesTable">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" name="activity_name[]" class="form-control" placeholder="e.g. International Seminar" disabled readonly></td>
                                    <td><input type="date" name="activity_date[]" class="form-control" disabled readonly></td>
                                    <td><input type="text" name="activity_description[]" class="form-control" placeholder="e.g. Speaker" disabled readonly></td>
                ...
                <div class="card glass-card mb-4 border-0 rounded-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text mb-3">Signature yang tersimpan.</div>
                ...
                <div class="d-flex justify-content-end gap-3 mb-5 mt-4">
                    <a href="{{ route('study-progress-report.index') }}" class="btn-cancel text-decoration-none"><i class="bi bi-arrow-left me-2"></i> Back</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (oldCompletedName && oldCompletedName.length > 0) {
            ...
            oldCompletedName.forEach((name, i) => {
                ...
                tbody.insertAdjacentHTML('beforeend', `<tr>
                    <td><input type="text" name="completed_courses_name[]" class="form-control" value="${escapeHtml(name)}" disabled readonly></td>
                    <td><input type="number" name="completed_courses_credits[]" class="form-control" min="1" value="${escapeHtml(credits)}" disabled readonly></td>
                    <td><input type="text" name="completed_courses_grade[]" class="form-control" value="${escapeHtml(grade)}" disabled readonly></td>
        ...
        if (oldOngoingName && oldOngoingName.length > 0) {
            ...
            oldOngoingName.forEach((name, i) => {
                ...
                tbody.insertAdjacentHTML('beforeend', `<tr>
                    <td><input type="text" name="ongoing_courses_name[]" class="form-control" value="${escapeHtml(name)}" disabled readonly></td>
                    <td><input type="number" name="ongoing_courses_credits[]" class="form-control" min="1" value="${escapeHtml(credits)}" disabled readonly></td>
        ...
        if (oldUpcomingName && oldUpcomingName.length > 0) {
            ...
            oldUpcomingName.forEach((name, i) => {
                ...
                tbody.insertAdjacentHTML('beforeend', `<tr>
                    <td><input type="text" name="upcoming_courses_name[]" class="form-control" value="${escapeHtml(name)}" disabled readonly></td>
                    <td><input type="number" name="upcoming_courses_credits[]" class="form-control" min="1" value="${escapeHtml(credits)}" disabled readonly></td>
        ...
        if (oldActivityName && oldActivityName.length > 0) {
            ...
            oldActivityName.forEach((name, i) => {
                ...
                tbody.insertAdjacentHTML('beforeend', `<tr>
                    <td><input type="text" name="activity_name[]" class="form-control" value="${escapeHtml(name)}" disabled readonly></td>
                    <td><input type="date" name="activity_date[]" class="form-control" value="${escapeHtml(date)}" disabled readonly></td>
                    <td><input type="text" name="activity_description[]" class="form-control" value="${escapeHtml(desc)}" disabled readonly></td>
